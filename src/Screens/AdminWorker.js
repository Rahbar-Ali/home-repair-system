    ...
    render() {
        return (
            <Header style={styles.headerstyle}>
                ...
                <Center><CenterText>Show Worker</CenterText></Center>
...
class AdminWorker extends Component {
            ...
            <KeyboardAvoid>
                <StyledContainer>
                    ...
                    <ContentCardTopServies>
                            <ScreenCartMain>
                                <ScreenCart>
                                    <Image source={require('../assets/images/worker-show.png')}
                                        style={styles.profileImageO}
                                    />
                                </ScreenCart>
                                <ScreenCartText>
                                    <ScreenCartTextInlineMain>
                                        <Text style={{fontSize: 16, fontWeight: 'bold'}}>Name : RAHBAR ALI </Text>
                                        <ScreenCartTextInlineExtraSec style= {{justifyContent: 'center'}}>
                                        <Text style={{fontSize: 13, fontWeight: 'bold'}}>AS A  </Text>
                                        </ScreenCartTextInlineExtraSec >
                                    <ScreenCartTextInlineExtra style={{borderWidth: 2, borderColor: "#a33f0d",}}>
                                        <Text style={{color: '#a33f0d', fontSize: 13, }}>PLUMBER </Text>
                                    ...
                                    <ScreenCartTextInlineViewFirst >
                                        <ScreenCartTextList>
                                        <Entypo name="mobile" color={"#fdbe61"} size={18} /> 
                                        </ScreenCartTextList>
                                        <View style={{marginLeft: 6, justifyContent: 'center'}}>
                                        <ScreenCartTextList>Mobile No: </ScreenCartTextList>
                                        </View>
                                        </ScreenCartTextInlineViewFirst>
                                    ...
                                    <ScreenCartTextInline>
                                        ...
                                        <ScreenCartTextInlineViewFirst >
                                            <ScreenCartTextList>
                                            <Entypo name="address" color={"#fdbe61"} size={18} /> 
                                            </ScreenCartTextList>
                                            <View style={{marginLeft: 6, justifyContent: 'center'}}>
                                            <ScreenCartTextList>Address: </ScreenCartTextList>
                                            </View>
                                            </ScreenCartTextInlineViewFirst>
                                            <ScreenCartTextInlineView style={{justifyContent: 'center'}}>
                                        ...
                                        <ScreenCartTextInlineViewFirst >
                                            <ScreenCartTextList>
                                            <Entypo name="document-landscape" color={"#fdbe61"} size={18} /> 
                                            </ScreenCartTextList>
                                            <View style={{marginLeft: 6, justifyContent: 'center'}}>
                                            <ScreenCartTextList>NIC: </ScreenCartTextList>
                                            </View>
                                            </ScreenCartTextInlineViewFirst>
                                            <ScreenCartTextInlineView style={{justifyContent: 'center'}}>
                                            <ScreenCartTextList >Known </ScreenCartTextList>
...
export default connect(mapStateToProp, mapsDispatchToProps)(AdminWorker);