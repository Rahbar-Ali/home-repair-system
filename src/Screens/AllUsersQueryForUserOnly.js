...
class AllUsersQueryForUserOnly extends Component {
    constructor(props) {
        super(props);
    ...
    GetAllUserQuery = () => {
        ...
        let url = GLOABAL_PATH.API_URL + Constants.ApiController.Login + Constants.ApiActionLogin.GetAllUserQueryForUsersOnly;
    ...
    } // end of GetAllUserQueryForUsersOnly
    ...
    SendItem = (item) => {
        this.props.navigation.navigate("ViewDetails", {
            ...
            Date_Time: item.CreatedDate,
            User_Comments: item.comments,
            Agent_Comments: item.AgentComments,
            User_Status: item.AgentStatus,
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <ListItem.Content>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                <Text style={styles.heading}>Agent Comments: </Text>
                                                <Text numberOfLines={1} style={styles.normalText}>
                                                    {item.AgentComments.length < 14 ? `${item.AgentComments}` : `${item.AgentComments.substring(0, 14)}...`}
                                                </Text>
                                            </View>
                                        ...
                                        <Right>
                                            <View onTouchStart={() => this.setState({ onSelectOptionMenu: item.LoginId })}>
                                                <OptionsMenu customButton={optionIcon} buttonStyle={{ width: 20, height: 4, margin: 7, resizeMode: "contain" }}
...
export default connect(mapStateToProps, mapsDispatchToProps)(AllUsersQueryForUserOnly);