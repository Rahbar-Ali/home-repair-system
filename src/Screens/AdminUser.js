    ...
    render() {
        return (
            <Header style={styles.headerstyle}>
                ...
                <Center><CenterText>Show Users</CenterText></Center>
            ...
            <KeyboardAvoid>
                <StyledContainer>
                    ...
                    <ContentCardTopServies>
                            <ScreenCartMain>
                                <ScreenCart>
                                    <Image source={require('../assets/images/user-show.png')}
                                ...
                                <ScreenCartText>
                                    ...
                                    <ScreenCartTextInlineExtra style={{borderWidth: 2, borderColor: "#a33f0d",}}>
                                        <Text style={{textAlign: 'center', color: '#a33f0d', fontSize: 13, }}>USER </Text>
...
export default connect(mapStateToProp, mapsDispatchToProps)(AdminUser);